...
$page_title = 'Pelaporan (Cetak) - Admin Pemkab Bombana';
            ...
            <div class="container-fluid p-4">
                ...
                <div class="card border-0 shadow-sm border-top border-primary border-4 mb-4">
                    <div class="card-header bg-white pt-3 pb-2 border-0">
                        <h6 class="fw-bold mb-0 text-primary"><i class="fas fa-filter me-1"></i> Filter Laporan</h6>
                    </div>
                        ...
                        <form method="GET" class="row g-3">
                            ...
                            <div class="col-md-12 d-flex justify-content-between align-items-center mt-3 border-top pt-3">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    ?>
                                    <a href="print.php?<?php echo $print_query; ?>" target="_blank" class="btn btn-warning fw-bold text-dark px-4"><i class="fas fa-print me-2"></i> Cetak Laporan</a>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover align-middle text-center" style="font-size: 0.9rem;">
                                ...
                                <tbody>
                                    ...
                                    if (empty($reports)): ?>
                                        <tr>
                                            <td colspan="7" class="py-4 text-muted">Data laporan tidak ditemukan untuk filter ini.</td>
                                        </tr>
                                        <?php else: foreach ($reports as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($s == 'diproses') echo '<span class="badge bg-warning text-dark border">Diproses</span>';
