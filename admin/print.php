...
// --- Bangun query dengan filter (sama seperti di reports.php) ---
$where  = "1=1";
$params = [];
...
// Label filter untuk subjudul cetak
$filter_label = '';
...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .kop-surat img { width: 75px; height: auto; }
        ...
        /* ===== RINGKASAN ===== */
        .summary-box { display: flex; gap: 20px; margin-bottom: 25px; font-size: 0.85rem; }
        .summary-item { border: 1px solid #000; padding: 6px 14px; text-align: center; }
...
<div class="print-container">
    ...
    <div class="doc-subtitle">
        ...
        &nbsp;&bull;&nbsp;Dicetak oleh: <?php echo htmlspecialchars($admin_name); ?>
    </div>
    ...
    <div class="ttd-wrap">
        <div class="ttd-box">
            ...
            <p class="ttd-name"><?php echo htmlspecialchars($admin_name); ?></p>
