...
$page_title = 'Detail Laporan - Kabid Pemkab Bombana';
$active_menu = 'reports';
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="card border-0 shadow-sm border-top border-warning border-4">
                            ...
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    <label class="form-label fw-bold">Status Laporan</label><br>
                                    <span class="badge bg-secondary p-2 fs-6"><?php echo htmlspecialchars($report['status']); ?></span>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label fw-bold">Tanggapan Instansi (Dari Admin)</label>
                                    <div class="p-3 bg-light rounded border">
                                        <?php echo nl2br(htmlspecialchars($report['tanggapan'] ?? 'Belum ada tanggapan.')); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
